...
const contratacaoDep1Cpf = document.getElementById("contratacao_dep1_cpf");
const contratacaoDep1Sexo = document.getElementById("contratacao_dep1_sexo");
const contratacaoDep1Rg = document.getElementById("contratacao_dep1_rg");
const contratacaoDep1DataEmissao = document.getElementById("contratacao_dep1_data_emissao_rg");
const contratacaoDep1OrgaoEmissor = document.getElementById("contratacao_dep1_orgao_emissor");
const contratacaoDep1EstadoCivil = document.getElementById("contratacao_dep1_estado_civil");
const contratacaoDep1CartaoNacionalSaude = document.getElementById("contratacao_dep1_cartao_nacional_saude");
const contratacaoDep1NomeMae = document.getElementById("contratacao_dep1_nome_mae");
const contratacaoDep1PlanoAnteriorSim = document.getElementById("contratacao_dep1_plano_anterior_sim");
const contratacaoDep1PlanoAnteriorNao = document.getElementById("contratacao_dep1_plano_anterior_nao");
const contratacaoDep1QualPlano = document.getElementById("contratacao_dep1_qual_plano");
const contratacaoDep1DataInicio = document.getElementById("contratacao_dep1_data_inicio");
const contratacaoDep1DataUltimoPagamento = document.getElementById("contratacao_dep1_data_ultimo_pagamento");
const docEntregueDep1CpfRgCnh = document.getElementById("doc_entregue_dep1_cpf_rg_cnh");
const docEntregueDep1Fotoselfie = document.getElementById("doc_entregue_dep1_fotoseIfie");
const docEntreguedep1ComprovanteResidencia = document.getElementById("doc_entregue_dep1_comprovante_residencia");
const docEntregueDep1ComprovanteVendaBeneficiario = document.getElementById("doc_entregue_dep1_comprovante_venda_beneficiario");
const docEntregueDep1Outros = document.getElementById("doc_entregue_dep1_outros");
const docEntregueDep1TempoPermanencia = document.getElementById("doc_entregue_dep1_declaracao_tempo_permanencia");
const contratacaoDep1QualOperadoraAnterior = document.getElementById("contratacao_dep1_qual_operadora_anterior");
const contratacaoDep1RegistroProdutoAnterior = document.getElementById("contratacao_dep1_registro_produto_anterior");
...
const contratacaoDep2Cpf = document.getElementById("contratacao_dep2_cpf");
const contratacaoDep2Sexo = document.getElementById("contratacao_dep2_sexo");
const contratacaoDep2Rg = document.getElementById("contratacao_dep2_rg");
const contratacaoDep2DataEmissao = document.getElementById("contratacao_dep2_data_emissao_rg");
const contratacaoDep2OrgaoEmissor = document.getElementById("contratacao_dep2_orgao_emissor");
const contratacaoDep2EstadoCivil = document.getElementById("contratacao_dep2_estado_civil");
const contratacaoDep2CartaoNacionalSaude = document.getElementById("contratacao_dep2_cartao_nacional_saude");
const contratacaoDep2NomeMae = document.getElementById("contratacao_dep2_nome_mae");
const contratacaoDep2PlanoAnteriorSim = document.getElementById("contratacao_dep2_plano_anterior_sim");
const contratacaoDep2PlanoAnteriorNao = document.getElementById("contratacao_dep2_plano_anterior_nao");
const contratacaoDep2QualPlano = document.getElementById("contratacao_dep2_qual_plano");
const contratacaoDep2DataInicio = document.getElementById("contratacao_dep2_data_inicio");
const contratacaoDep2DataUltimoPagamento = document.getElementById("contratacao_dep2_data_ultimo_pagamento");
const docEntregueDep2CpfRgCnh = document.getElementById("doc_entregue_dep2_cpf_rg_cnh");
const docEntregueDep2Fotoselfie = document.getElementById("doc_entregue_dep2_fotoseIfie");
const docEntreguedep2ComprovanteResidencia = document.getElementById("doc_entregue_dep2_comprovante_residencia");
const docEntregueDep2ComprovanteVendaBeneficiario = document.getElementById("doc_entregue_dep2_comprovante_venda_beneficiario");
const docEntregueDep2Outros = document.getElementById("doc_entregue_dep2_outros");
const docEntregueDep2TempoPermanencia = document.getElementById("doc_entregue_dep2_declaracao_tempo_permanencia");
const contratacaoDep2QualOperadoraAnterior = document.getElementById("contratacao_dep2_qual_operadora_anterior");
const contratacaoDep2RegistroProdutoAnterior = document.getElementById("contratacao_dep2_registro_produto_anterior");
...
const contratacaoDep3Cpf = document.getElementById("contratacao_dep3_cpf");
const contratacaoDep3Sexo = document.getElementById("contratacao_dep3_sexo");
const contratacaoDep3Rg = document.getElementById("contratacao_dep3_rg");
const contratacaoDep3DataEmissao = document.getElementById("contratacao_dep3_data_emissao_rg");
const contratacaoDep3OrgaoEmissor = document.getElementById("contratacao_dep3_orgao_emissor");
const contratacaoDep3EstadoCivil = document.getElementById("contratacao_dep3_estado_civil");
const contratacaoDep3CartaoNacionalSaude = document.getElementById("contratacao_dep3_cartao_nacional_saude");
const contratacaoDep3NomeMae = document.getElementById("contratacao_dep3_nome_mae");
const contratacaoDep3PlanoAnteriorSim = document.getElementById("contratacao_dep3_plano_anterior_sim");
const contratacaoDep3PlanoAnteriorNao = document.getElementById("contratacao_dep3_plano_anterior_nao");
const contratacaoDep3QualPlano = document.getElementById("contratacao_dep3_qual_plano");
const contratacaoDep3DataInicio = document.getElementById("contratacao_dep3_data_inicio");
const contratacaoDep3DataUltimoPagamento = document.getElementById("contratacao_dep3_data_ultimo_pagamento");
const docEntregueDep3CpfRgCnh = document.getElementById("doc_entregue_dep3_cpf_rg_cnh");
const docEntregueDep3Fotoselfie = document.getElementById("doc_entregue_dep3_fotoseIfie");
const docEntreguedep3ComprovanteResidencia = document.getElementById("doc_entregue_dep3_comprovante_residencia");
const docEntregueDep3ComprovanteVendaBeneficiario = document.getElementById("doc_entregue_dep3_comprovante_venda_beneficiario");
const docEntregueDep3Outros = document.getElementById("doc_entregue_dep3_outros");
const docEntregueDep3TempoPermanencia = document.getElementById("doc_entregue_dep3_declaracao_tempo_permanencia");
const contratacaoDep3QualOperadoraAnterior = document.getElementById("contratacao_dep3_qual_operadora_anterior");
const contratacaoDep3RegistroProdutoAnterior = document.getElementById("contratacao_dep3_registro_produto_anterior");
...
const contratacaoDep4Cpf = document.getElementById("contratacao_dep4_cpf");
const contratacaoDep4Sexo = document.getElementById("contratacao_dep4_sexo");
const contratacaoDep4Rg = document.getElementById("contratacao_dep4_rg");
const contratacaoDep4DataEmissao = document.getElementById("contratacao_dep4_data_emissao_rg");
const contratacaoDep4OrgaoEmissor = document.getElementById("contratacao_dep4_orgao_emissor");
const contratacaoDep4EstadoCivil = document.getElementById("contratacao_dep4_estado_civil");
const contratacaoDep4CartaoNacionalSaude = document.getElementById("contratacao_dep4_cartao_nacional_saude");
const contratacaoDep4NomeMae = document.getElementById("contratacao_dep4_nome_mae");
const contratacaoDep4PlanoAnteriorSim = document.getElementById("contratacao_dep4_plano_anterior_sim");
const contratacaoDep4PlanoAnteriorNao = document.getElementById("contratacao_dep4_plano_anterior_nao");
const contratacaoDep4QualPlano = document.getElementById("contratacao_dep4_qual_plano");
const contratacaoDep4DataInicio = document.getElementById("contratacao_dep4_data_inicio");
const contratacaoDep4DataUltimoPagamento = document.getElementById("contratacao_dep4_data_ultimo_pagamento");
const docEntregueDep4CpfRgCnh = document.getElementById("doc_entregue_dep4_cpf_rg_cnh");
const docEntregueDep4Fotoselfie = document.getElementById("doc_entregue_dep4_fotoseIfie");
const docEntreguedep4ComprovanteResidencia = document.getElementById("doc_entregue_dep4_comprovante_residencia");
const docEntregueDep4ComprovanteVendaBeneficiario = document.getElementById("doc_entregue_dep4_comprovante_venda_beneficiario");
const docEntregueDep4Outros = document.getElementById("doc_entregue_dep4_outros");
const docEntregueDep4TempoPermanencia = document.getElementById("doc_entregue_dep4_declaracao_tempo_permanencia");
const contratacaoDep4QualOperadoraAnterior = document.getElementById("contratacao_dep4_qual_operadora_anterior");
const contratacaoDep4RegistroProdutoAnterior = document.getElementById("contratacao_dep4_registro_produto_anterior");
...
const odontoDep1Nome = document.getElementById("odonto_dep1_nome");
const odontoDep1Cpf = document.getElementById("odonto_dep1_cpf");
const odontoDep1DataNascimento = document.getElementById("odonto_dep1_data_nascimento");
const odontoDep1Sexo = document.getElementById("odonto_dep1_sexo");
const odontoDep1EstadoCivil = document.getElementById("odonto_dep1_estado_civil");
const odontoDep1NomeMae = document.getElementById("odonto_dep1_mae");
const odontoDep1Parentesco = document.getElementById("odonto_dep1_parentesco");
const odontoDep2Nome = document.getElementById("odonto_dep2_nome");
const odontoDep2Cpf = document.getElementById("odonto_dep2_cpf");
const odontoDep2DataNascimento = document.getElementById("odonto_dep2_data_nascimento");
const odontoDep2Sexo = document.getElementById("odonto_dep2_sexo");
const odontoDep2EstadoCivil = document.getElementById("odonto_dep2_estado_civil");
const odontoDep2NomeMae = document.getElementById("odonto_dep2_mae");
const odontoDep2Parentesco = document.getElementById("odonto_dep2_parentesco");
const odontoDep3Nome = document.getElementById("odonto_dep3_nome");
const odontoDep3Cpf = document.getElementById("odonto_dep3_cpf");
const odontoDep3DataNascimento = document.getElementById("odonto_dep3_data_nascimento");
const odontoDep3Sexo = document.getElementById("odonto_dep3_sexo");
const odontoDep3EstadoCivil = document.getElementById("odonto_dep3_estado_civil");
const odontoDep3NomeMae = document.getElementById("odonto_dep3_mae");
const odontoDep3Parentesco = document.getElementById("odonto_dep3_parentesco");
const odontoDep4Nome = document.getElementById("odonto_dep4_nome");
const odontoDep4Cpf = document.getElementById("odonto_dep4_cpf");
const odontoDep4DataNascimento = document.getElementById("odonto_dep4_data_nascimento");
const odontoDep4Sexo = document.getElementById("odonto_dep4_sexo");
const odontoDep4EstadoCivil = document.getElementById("odonto_dep4_estado_civil");
const odontoDep4NomeMae = document.getElementById("odonto_dep4_mae");
const odontoDep4Parentesco = document.getElementById("odonto_dep4_parentesco");
...
const QuartoCompartilhado = document.getElementById("acomodacao_qc");
const QuartoPrivado = document.getElementById("acomodacao_qp");
const coparticipacao = document.getElementById("contratacao_resumo_coparticipacao");
...
function updateOdontoTitularFields() {
    ...
    if(odontoDep4Nome) odontoDep4Nome.value = dep4NomeInput ? dep4NomeInput.value : '';

    if(odontoDep4Cpf) odontoDep4Cpf.value = contratacaoDep4Cpf ? contratacaoDep4Cpf.value : '';

    if(odontoDep4DataNascimento) odontoDep4DataNascimento.value = dep4NascInput ? dep4NascInput.value : '';


    if (odontoDep4Sexo) {
        const sourceValue = contratacaoDep4Sexo ? contratacaoDep4Sexo.value : '';
        // Convert 'M'/'F' to 'Masculino'/'Feminino' for the target select
        const mappedValue = sourceValue === 'Masculino' ? 'M' : (sourceValue === 'Feminino' ? 'F' : '');
        const optionExists = Array.from(odontoDep4Sexo.options).some(option => option.value === mappedValue);
        odontoDep4Sexo.value = optionExists ? mappedValue : '';
    ...
    if(odontoDep4Parentesco) odontoDep4Parentesco.value = dep4ParentescoInput ? dep4ParentescoInput.value : '';

    if(odontoDep4EstadoCivil) odontoDep4EstadoCivil.value = contratacaoDep4EstadoCivil ? contratacaoDep4EstadoCivil.value : '';


    if(odontoDep4NomeMae) odontoDep4NomeMae.value = contratacaoDep4NomeMae ? contratacaoDep4NomeMae.value : '';




    if(odontoDep3Nome) odontoDep3Nome.value = dep3NomeInput ? dep3NomeInput.value : '';

    if(odontoDep3Cpf) odontoDep3Cpf.value = contratacaoDep3Cpf ? contratacaoDep3Cpf.value : '';

    if(odontoDep3DataNascimento) odontoDep3DataNascimento.value = dep3NascInput ? dep3NascInput.value : '';


    if (odontoDep3Sexo) {
        const sourceValue = contratacaoDep3Sexo ? contratacaoDep3Sexo.value : '';
        // Convert 'M'/'F' to 'Masculino'/'Feminino' for the target select
        const mappedValue = sourceValue === 'Masculino' ? 'M' : (sourceValue === 'Feminino' ? 'F' : '');
        const optionExists = Array.from(odontoDep3Sexo.options).some(option => option.value === mappedValue);
        odontoDep3Sexo.value = optionExists ? mappedValue : '';
        if (sourceValue !== '' && mappedValue === '' && !optionExists) {
             console.warn(`Sex value "${sourceValue}" from source field could not be mapped or is not a valid option in the target select.`);
        }
    }

    if(odontoDep3Parentesco) odontoDep3Parentesco.value = dep3ParentescoInput ? dep3ParentescoInput.value : '';

    if(odontoDep3EstadoCivil) odontoDep3EstadoCivil.value = contratacaoDep3EstadoCivil ? contratacaoDep3EstadoCivil.value : '';


    if(odontoDep3NomeMae) odontoDep3NomeMae.value = contratacaoDep3NomeMae ? contratacaoDep3NomeMae.value : '';


    if(odontoDep2Nome) odontoDep2Nome.value = dep2NomeInput ? dep2NomeInput.value : '';

    if(odontoDep2Cpf) odontoDep2Cpf.value = contratacaoDep2Cpf ? contratacaoDep2Cpf.value : '';

    if(odontoDep2DataNascimento) odontoDep2DataNascimento.value = dep2NascInput ? dep2NascInput.value : '';


    if (odontoDep2Sexo) {
        const sourceValue = contratacaoDep2Sexo ? contratacaoDep2Sexo.value : '';
        // Convert 'M'/'F' to 'Masculino'/'Feminino' for the target select
        const mappedValue = sourceValue === 'Masculino' ? 'M' : (sourceValue === 'Feminino' ? 'F' : '');
        const optionExists = Array.from(odontoDep2Sexo.options).some(option => option.value === mappedValue);
        odontoDep2Sexo.value = optionExists ? mappedValue : '';
        if (sourceValue !== '' && mappedValue === '' && !optionExists) {
             console.warn(`Sex value "${sourceValue}" from source field could not be mapped or is not a valid option in the target select.`);
        }
    }

    if(odontoDep2Parentesco) odontoDep2Parentesco.value = dep2ParentescoInput ? dep2ParentescoInput.value : '';

    if(odontoDep2EstadoCivil) odontoDep2EstadoCivil.value = contratacaoDep2EstadoCivil ? contratacaoDep2EstadoCivil.value : '';


    if(odontoDep2NomeMae) odontoDep2NomeMae.value = contratacaoDep2NomeMae ? contratacaoDep2NomeMae.value : '';


    if(contratacaoContratanteTelefoneFixoInput) contratacaoContratanteTelefoneFixoInput.value = telInput ? telInput.value : '';
    ...
    if(odontoTitularNumeroInput) odontoTitularNumeroInput.value = numInput.value + complInput.value;
    ...
    if(odontoTitularSexoSelect) odontoTitularSexoSelect.value = sexoInput? sexoInput.value : '';
    ...
    if(odontoDep1Nome) odontoDep1Nome.value = dep1NomeInput ? dep1NomeInput.value : '';

    if(odontoDep1Cpf) odontoDep1Cpf.value = contratacaoDep1Cpf ? contratacaoDep1Cpf.value : '';

    if(odontoDep1DataNascimento) odontoDep1DataNascimento.value = dep1NascInput ? dep1NascInput.value : '';


    if (odontoDep1Sexo) {
        const sourceValue = contratacaoDep1Sexo ? contratacaoDep1Sexo.value : '';
        // Convert 'M'/'F' to 'Masculino'/'Feminino' for the target select
        const mappedValue = sourceValue === 'Masculino' ? 'M' : (sourceValue === 'Feminino' ? 'F' : '');
        const optionExists = Array.from(odontoDep1Sexo.options).some(option => option.value === mappedValue);
        odontoDep1Sexo.value = optionExists ? mappedValue : '';
        if (sourceValue !== '' && mappedValue === '' && !optionExists) {
             console.warn(`Sex value "${sourceValue}" from source field could not be mapped or is not a valid option in the target select.`);
        }
    }

    if(odontoDep1Parentesco) odontoDep1Parentesco.value = dep1ParentescoInput ? dep1ParentescoInput.value : '';

    if(odontoDep1EstadoCivil) odontoDep1EstadoCivil.value = contratacaoDep1EstadoCivil ? contratacaoDep1EstadoCivil.value : '';

    if(contratacaoDep1NomeInput) contratacaoDep1NomeInput.value = dep1NomeInput ? dep1NomeInput.value : '';

    if(odontoDep1NomeMae) odontoDep1NomeMae.value = contratacaoDep1NomeMae ? contratacaoDep1NomeMae.value : '';
...
contratacaoDep4NomeMae?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep4EstadoCivil?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep4Sexo?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep4Cpf?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep3NomeMae?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep3EstadoCivil?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep3Sexo?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep3Cpf?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep2NomeMae?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep2EstadoCivil?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep2Sexo?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep2Cpf?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep1Sexo?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep1NomeMae?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep1EstadoCivil?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});

contratacaoDep1Cpf?.addEventListener('input', () => {
updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});
...
dep1ParentescoInput?.addEventListener('input', () => {
 updateOdontoTitularFields();
    updateContratanteFields();
    updateContratacaoResponsavelFields();
});
...
function collectFormData() {
    ...
    const inputs = document.querySelectorAll(
        ...
        '#QuartoCompartilhado, #QuartoPrivado, #coparticipacao'+
        '#pesoTitularDeclaracao, #pesoDep1Declaracao, #pesoDep2Declaracao, #pesoDep3Declaracao, #pesoDep4Declaracao, #alturaTitularDeclaracao, #alturaDep1Declaracao, #alturaDep2Declaracao, #alturaDep3Declaracao, #alturaDep4Declaracao'
    );
    inputs.forEach(input => {
        let value = '';
